...
namespace WebAppDotNetWebFormsTest.API
{
    public partial class TGZCOGetEnedoShopInfo : System.Web.UI.UserControl
    {
            ...
            using (var context = new TohogasDataContext())
            {
                ...
                try
                {
                    ...
                    /*if (result!=0)
                    {
                        ...
                        this.Response.Output.Write(this.getJson(address, phonenumber, servicename, proprietaryservice));
                        TGZZZLog.EndLog();
                        this.Response.End();
                        return;
                    }*/
        ...
        {
            int checkStringType = TGZZZCom08.CheckStringType(organizationNumber, TGZZZConstants.CHECK_STRING_TYPE_HALFALPHNUM);
            int len = organizationNumber.Trim().Length;
